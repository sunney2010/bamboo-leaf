package com.bamboo.leaf.common.dao.impl;

import com.bamboo.leaf.common.constant.ConfigConstant;
import com.bamboo.leaf.common.constant.SequenceConstant;
import com.bamboo.leaf.common.dao.AbstractWorkerId;
import com.bamboo.leaf.common.dao.WorkerIdDAO;
 ...
 */
public class WorkerIdDAOImpl extends AbstractWorkerId implements WorkerIdDAO {
    ...
    protected boolean insertSql(Connection conn, PreparedStatement stmt, String nameSpace, String hostIp, int workerId)
            throws BambooLeafException {
        boolean val = false;
        try {
            conn = dataSource.getConnection();
